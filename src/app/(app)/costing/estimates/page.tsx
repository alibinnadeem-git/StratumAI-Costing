...
export default async function EstimatesPage() {
  ...
  return <div className="space-y-5">
    ...
    <section className="stratum-sheet"><div className="table-scroll"><table className="min-w-[980px]"><thead><tr><th>Estimate</th><th>Project</th><th>Status</th><th>Condition</th><th>Updated</th><th className="num">Price</th><th>Actions</th></tr></thead><tbody>{estimates.map((estimate) => {
