...
const PRIMARY_NAV = [
  ...
  { href: "/edge", label: "STRATUM Edge", icon: Gauge },
];
  ...
  return (
    <div className="stratum-workspace">
      ...
      <header className="stratum-shell sticky top-0 z-40">
        ...
        <div className="stratum-tabs relative overflow-visible">
          <nav className="mx-auto flex max-w-[1280px] items-stretch px-3 sm:px-7" aria-label="Primary workspace navigation">
